  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-panel p-6 border-emerald-500/30 relative overflow-hidden group">
          ...
          <button className="flex items-center gap-2 text-emerald-400 font-medium hover:text-emerald-300 transition-colors">
      ...
      <div className="glass-panel p-6 mt-6">
        ...
        <div className="space-y-4">
          {workflows.map(wf => (
            <div key={wf.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg bg-gray-900/40 border border-gray-800 hover:border-emerald-500/30 transition-colors gap-4">
              <div className="flex items-center gap-4">
                <div className={`p-3 rounded-lg border ${
                  wf.status === 'Active' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-gray-800 text-gray-400 border-gray-700'
                }`}>
              ...
              <div className="flex items-center gap-6 justify-between sm:justify-end border-t sm:border-t-0 border-gray-800 pt-4 sm:pt-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button className="p-2 text-gray-400 hover:text-emerald-400 transition-colors ml-2">
