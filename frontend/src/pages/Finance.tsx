    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="glass-panel p-6 relative overflow-hidden group">
          ...
          <div className="mt-4 flex items-center text-sm font-medium text-blue-400 bg-blue-500/10 w-max px-2 py-1 rounded border border-blue-500/20">
        ...
        <div className="glass-panel p-6">
          ...
          <h2 className="text-3xl font-bold text-blue-400">$18,200.00</h2>
            ...
            {transactions.map(trx => (
              <div key={trx.id} className="flex items-center justify-between p-4 rounded-lg bg-gray-900/40 border border-gray-800 hover:border-gray-700 transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`p-2 rounded-lg ${trx.type === 'income' ? 'bg-blue-500/10 text-blue-400' : 'bg-red-500/10 text-red-400'}`}>
                ...
                <div className="text-right">
                  <p className={`font-bold ${trx.type === 'income' ? 'text-blue-400' : 'text-gray-200'}`}>
        ...
        <div className="glass-panel p-6">
          ...
          <div className="mt-6 border-t border-gray-800 pt-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 p-3 rounded-lg bg-gray-900 border border-gray-700 text-gray-300 hover:text-blue-400 hover:border-blue-500/50 transition-all font-medium text-sm">
