          ...
          <div className="glass-panel p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 rounded-lg bg-gray-900/50 border border-gray-700 text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  rows={4}
                  className="w-full px-4 py-2 rounded-lg bg-gray-900/50 border border-gray-700 text-gray-100 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors resize-none"
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6">
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30 flex items-start gap-3">
              ...
              <div>
                <h3 className="text-blue-400 font-medium">Business Verified</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 rounded-lg bg-gray-900/50 border border-gray-800">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-bold">A</div>
                  <div>
              ...
              <button className="w-full py-2 border border-dashed border-gray-600 rounded-lg text-gray-400 hover:text-blue-400 hover:border-blue-500/50 transition-colors text-sm font-medium">
                + Invite Member
              </button>
            </div>
          </div>
